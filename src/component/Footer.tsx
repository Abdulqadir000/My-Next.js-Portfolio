    ...
    <footer className="bg-black py-8 mt-5 text-white items-center justify-center">
      <div className="container mx-auto flex justify-center items-center">
        <div className="flex items-center">
          ...
          <a href="https://www.linkedin.com/in/abdul-qadir-khan-781266205?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app" target="_blank" rel="noopener noreferrer">
      ...
      <div className="container mx-auto text-center mt-4">
        <p className="text-sm">&copy; 2024 Abdul Qadir Khan ❤️ All rights reserved.</p>
      </div>
